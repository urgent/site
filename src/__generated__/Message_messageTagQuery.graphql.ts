/**
 * @generated SignedSource<<68aa1cc949f071cfd0dadee9557eeee1>>
...
export type Message_messageTagQuery$variables = {
  message: number;
  organization: number;
  tag?: ReadonlyArray<number | null> | null;
};
export type Message_messageTagQueryVariables = Message_messageTagQuery$variables;
export type Message_messageTagQuery$data = {
  readonly query: {
    readonly " $fragmentSpreads": FragmentRefs<"Message_messageTagFragment" | "SidebarFragment_messages" | "SidebarFragment_categories" | "NavFragment_organization">;
  };
};
export type Message_messageTagQueryResponse = Message_messageTagQuery$data;
export type Message_messageTagQuery = {
  variables: Message_messageTagQueryVariables;
  response: Message_messageTagQuery$data;
};
