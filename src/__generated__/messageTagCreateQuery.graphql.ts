/**
 * @generated SignedSource<<2f92149037d52390efa05ae2e4086852>>
...
export type messageTagCreateQuery$variables = {
  organization: number;
  tag?: ReadonlyArray<number | null> | null;
};
export type messageTagCreateQueryVariables = messageTagCreateQuery$variables;
export type messageTagCreateQuery$data = {
  readonly query: {
    readonly " $fragmentSpreads": FragmentRefs<"SidebarFragment_messages" | "SidebarFragment_categories" | "NavFragment_organization">;
  };
};
export type messageTagCreateQueryResponse = messageTagCreateQuery$data;
export type messageTagCreateQuery = {
  variables: messageTagCreateQueryVariables;
  response: messageTagCreateQuery$data;
};
