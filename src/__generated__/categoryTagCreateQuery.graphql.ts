/**
 * @generated SignedSource<<4a70b5c6f3399f41bc7ee717e8461149>>
...
export type categoryTagCreateQuery$variables = {
  organization: number;
  tag?: ReadonlyArray<number | null> | null;
};
export type categoryTagCreateQueryVariables = categoryTagCreateQuery$variables;
export type categoryTagCreateQuery$data = {
  readonly query: {
    readonly " $fragmentSpreads": FragmentRefs<"SidebarFragment_messages" | "SidebarFragment_categories" | "NavFragment_organization">;
  };
};
export type categoryTagCreateQueryResponse = categoryTagCreateQuery$data;
export type categoryTagCreateQuery = {
  variables: categoryTagCreateQueryVariables;
  response: categoryTagCreateQuery$data;
};
